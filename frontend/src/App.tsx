...
const App = () => (
  <div className="min-h-screen bg-slate-100">
    <nav className="fixed top-0 left-0 right-0 z-50 border-b border-slate-200 bg-white/80 backdrop-blur">
      <div className="mx-auto w-full max-w-6xl px-4 py-3 sm:py-4 md:px-6 lg:px-8">
        {/* Desktop layout */}
        ...
        <div className="flex flex-col gap-2.5 sm:hidden">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand/10 text-base font-bold text-brand">
              KC
            </div>
            <div>
              <p className="text-xs font-semibold uppercase tracking-wide text-brand-dark">Kube Credential</p>
            </div>
          </div>
    ...
    <main className="pt-[108px] pb-16 sm:pt-24">
      <Routes>
